...
public class OptionalUpdateSerializer
    extends StdSerializer<OptionalUpdate<?>>
    implements ContextualSerializer
{
    ...
    public OptionalUpdateSerializer(JavaType type) {
        this((ReferenceType) type, null, null);
    }

    @SuppressWarnings("unchecked")
    public OptionalUpdateSerializer(ReferenceType optionalType,
    ...
    @SuppressWarnings("unchecked")
    protected OptionalUpdateSerializer(OptionalUpdateSerializer base, BeanProperty property,
                                       TypeSerializer vts, JsonSerializer<?> valueSer,
    ...
    @Override
    public JsonSerializer<OptionalUpdate<?>> unwrappingSerializer(NameTransformer transformer) {
    ...
    protected OptionalUpdateSerializer withResolved(BeanProperty prop,
                                                    TypeSerializer vts, JsonSerializer<?> valueSer,
                                                    NameTransformer unwrapper, JsonInclude.Include contentIncl)
    {
        ...
        return new OptionalUpdateSerializer(this, prop, vts, valueSer, unwrapper, contentIncl);
    }
    ...
    @Override
    public boolean isEmpty(SerializerProvider provider, OptionalUpdate<?> value)
    {
        if (value == null || value.isPreserve()) {
            return true;
        }
    ...
    @Override
    public void serialize(OptionalUpdate<?> opt, JsonGenerator gen, SerializerProvider provider)
        throws IOException
    {
        if (!opt.isUpdate()) {
    ...
    @Override
    public void serializeWithType(OptionalUpdate<?> opt,
                                  ...
                                  TypeSerializer typeSer) throws IOException
    {
        ...
        typeSer.writeTypePrefix(gen, typeSer.typeId(opt, OptionalUpdate.class, JsonToken.VALUE_STRING));
        serialize(opt, gen, provider);
        typeSer.writeTypeSuffix(gen, typeSer.typeId(opt, JsonToken.VALUE_STRING));
    }
